...
export const ACHIEVEMENT_LIST: readonly AchievementDef[] = [
  ...
  def('PIONEER', 'rari', 'shield', 'rocket', 'Pioniere', "Una visita verificata in un McDonald's appena aperto"),
  def('CRITIC', 'rari', 'shield', 'star', 'Critico gastronomico', "Vota almeno 10 McDonald's che hai visitato"),
  def('GPS_VERIFIED', 'rari', 'shield', 'pincheck', 'Sul posto', "25 visite verificate: segnate mentre eri davvero lì"),
  def('NIGHT_OWL', 'segreti', 'circle', 'moon', 'Nottambulo', 'Una visita verificata tra mezzanotte e le cinque', true),
  def('FERRAGOSTO', 'segreti', 'circle', 'sun', 'Ferragosto a tavola', "Una visita verificata il 15 agosto", true),
  def('DOUBLE', 'segreti', 'circle', 'two', 'Doppietta', "Due visite verificate nello stesso giorno", true),
